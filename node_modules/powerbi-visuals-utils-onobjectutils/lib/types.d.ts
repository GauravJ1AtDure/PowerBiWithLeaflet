...
export interface ISubSelectionHelper<TElement, TIdentifier = unknown> {
     ...
     */
    updateElementOutline(element: TElement, visibility: SubSelectionOutlineVisibility): SubSelectionRegionOutlineId;
    /**
     ...
     */
    updateElementOutlines(elements: TElement[], visibility: SubSelectionOutlineVisibility): SubSelectionRegionOutlineId[];
    /**
     * Updates the given outline
     */
    updateRegionOutline(outline: SubSelectionRegionOutline): void;
    /**
     * Updates the given outlines
     */
    updateRegionOutlines(outlines: SubSelectionRegionOutline[]): void;
    /**
